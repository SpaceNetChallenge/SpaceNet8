...
if __name__ == "__main__":
    ...
    parser.add_argument("--rescale_type", type=str, default="perc", help="clip, perc, tot_8band, tot_3band")
    parser.add_argument(
        "--band_order",
        type=str,
        default="5,3,2",
    ...
    parser.add_argument("--percentiles", type=str, default="2,98", help="',' separated list of min,max percentiles")
    parser.add_argument("--max_zero_frac", type=float, default=0.3, help="max percentage of image we allow to be null")
    parser.add_argument("--n_threads", type=int, default=12, help="num threads for multiprocessing")
