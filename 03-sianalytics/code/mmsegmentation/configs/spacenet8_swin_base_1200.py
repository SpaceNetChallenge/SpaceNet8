...
data = dict(
    ...
    train=[
        dict(
            ...
            img_dir='/data/datasets/SpaceNet8/mmstyle/train/',
            ann_dir='/data/datasets/SpaceNet8/mmstyle/train',
            pipeline=train_pipeline)
    ],
    val=dict(
        type='SpaceNet8Dataset',
        img_dir='/data/datasets/SpaceNet8/mmstyle/val/',
        ann_dir='/data/datasets/SpaceNet8/mmstyle/val',
...
evaluation = dict(interval=6, metric='mIoU', pre_eval=True)
model = dict(
    type='ChangeDetector',
    backbone=dict(
