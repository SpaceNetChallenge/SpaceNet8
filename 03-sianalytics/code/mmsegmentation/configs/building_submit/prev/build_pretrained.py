train_pipeline = [
    ...
    dict(type='RandomCrop', crop_size=(650, 650)),
...
data = dict(
    ...
    train=[
        dict(
            ...
            img_dir='/data/datasets/spacenet/mmstyle/img_dir/train',
            ann_dir='/data/datasets/spacenet/mmstyle/ann_dir/train',
            pipeline=train_pipeline)
    ],
    val=dict(
        type='SpaceNet8BuildingDataset',
        img_dir='/data/datasets/SpaceNet8/mmstyle/val/pre',
        ann_dir='/data/datasets/SpaceNet8/mmstyle/val/building',
