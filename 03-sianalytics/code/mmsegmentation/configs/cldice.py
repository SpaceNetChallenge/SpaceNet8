train_pipeline = [
    ...
    dict(type='MergeClasses'),
    dict(type='Resize', ratio_range=(0.8, 1.2)),
    dict(type='RandomRotate', prob=0.5, degree=(-45, 45)),
    dict(type='RandomCrop', crop_size=(1024, 1024), cat_max_ratio=0.95),
...
data = dict(
    ...
    train=[
        dict(
            type='SpaceNet8FoundationDataset',
...
model = dict(
    ...
    auxiliary_head=dict(
        ...
        loss_decode=[
            ...
            dict(type='CLDiceLoss', loss_weight=0.4)
        ]),
    train_cfg=dict(),
