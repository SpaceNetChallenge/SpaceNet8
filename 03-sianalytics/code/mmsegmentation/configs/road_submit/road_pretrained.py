...
data = dict(
    ...
    train=[
        dict(
            ...
            img_dir='/data/SpaceNet3/img_dir/train',
            ann_dir='/data/SpaceNet3/ann_dir/train',
            pipeline=train_pipeline),
        dict(
            type='MassachusettsRoadDataset',
            img_dir='/data/massachusetts/road/train/images/',
            ann_dir='/data/massachusetts/road/train/masks/',
            pipeline=train_pipeline),
        dict(
            type='MassachusettsRoadDataset',
            img_dir='/data/massachusetts/road/valid/images/',
            ann_dir='/data/massachusetts/road/valid/masks/',
            pipeline=train_pipeline),
        dict(
            type='MassachusettsRoadDataset',
            img_dir='/data/massachusetts/road/test/images/',
            ann_dir='/data/massachusetts/road/test/masks/',
            pipeline=train_pipeline),
        dict(
            type='DeepGlobeRoadDataset',
            img_dir='/data/DeepGlobe/train',
            ann_dir='/data/DeepGlobe/train',
            pipeline=train_pipeline),
    ],
    val=dict(
        type='SpaceNet8RoadDataset',
